...
class EnrollmentDX extends DXController
{
    ...
    protected function getFlow(array $context): array
    {
        ...
        $postEndpoint = $base . $sep . 'dx=enrollment';

        return [
            'dx_id'         => 'enrollment',
            'title'         => 'Student Enrollment',
            'description'   => 'Register a new student for enrollment in two steps.',
            'version'       => '1.0',
    ...
    {
        return $this->step('enrollment_details', 'Enrollment Information', [
    ...
    {
        return $this->step('interview_data', 'Interview Data', [
